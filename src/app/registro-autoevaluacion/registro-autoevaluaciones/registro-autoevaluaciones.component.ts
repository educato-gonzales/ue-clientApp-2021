...
@Component({
  selector: 'app-registro-autoevaluaciones',
  templateUrl: './registro-autoevaluaciones.component.html',
  styleUrls: ['./registro-autoevaluaciones.component.css']
})
export class RegistroAutoevaluacionesComponent implements OnInit {

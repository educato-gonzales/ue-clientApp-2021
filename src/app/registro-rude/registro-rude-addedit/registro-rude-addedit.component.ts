...
@Component({
  selector: 'app-registro-rude-addedit',
  templateUrl: './registro-rude-addedit.component.html',
  styleUrls: ['./registro-rude-addedit.component.css']
})
export class RegistroRudeAddeditComponent implements OnInit {
  ...
  constructor( private rudeService: RudeService, private formBuilder: FormBuilder, private avRoute: ActivatedRoute, private router: Router,
    ...
    this.form = this.formBuilder.group(
      {//esto es para registrar lo de la vista que se necesita
        ...
        idRepresentantePadre: [''],
        idRepresentanteMadre: [''],
        idRepresentanteTutor: [''],
  ...
  save(){
    ...
    if (this.actionType === 'Add'){
      const rude: Rude = {
        ...
        numDiscapacidad: Number(this.form.get(this.formNumDiscapacidad).value),
      ...
      .subscribe((data) => {
        this.router.navigate(['/registro-representante']);
      }
      ,err => {
        console.log(err);

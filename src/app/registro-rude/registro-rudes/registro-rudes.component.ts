...
@Component({
  selector: 'app-registro-rudes',
  templateUrl: './registro-rudes.component.html',
  styleUrls: ['./registro-rudes.component.css']
})
export class RegistroRudesComponent implements OnInit {

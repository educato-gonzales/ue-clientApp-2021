...
@Component({
  selector: 'app-registro-estudiante-addedit',
  templateUrl: './registro-estudiante-addedit.component.html',
  styleUrls: ['./registro-estudiante-addedit.component.css']
})
export class RegistroEstudianteAddeditComponent implements OnInit {
  ...
  save(){
    ...
    if (this.actionType === 'Add'){
      ...
      .subscribe((data) => {
        ...
        this.router.navigate(['/addRegistroUsuario/', this.listaLogin['id'], 'Estudiante']);
      });
    }
  ...
  /*crearUsuario(){
    this.router.navigate(['/addRegistroUsuario']);
  }*/
}

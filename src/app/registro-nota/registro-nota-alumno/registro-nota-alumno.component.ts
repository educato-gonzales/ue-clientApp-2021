...
@Component({
  selector: 'app-registro-nota-alumno',
  templateUrl: './registro-nota-alumno.component.html',
  styleUrls: ['./registro-nota-alumno.component.css']
})
export class RegistroNotaAlumnoComponent implements OnInit {
  ...
  save(){
    ...
    if (this.actionType === 'Add'){
      ...
      .subscribe((data) => {
        ...
        this.router.navigate(['/addRegistroEvaluacionAlumno/', this.listId['id']]);
      });
    }
  }

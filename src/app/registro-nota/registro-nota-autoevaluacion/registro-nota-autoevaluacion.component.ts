...
@Component({
  selector: 'app-registro-nota-autoevaluacion',
  templateUrl: './registro-nota-autoevaluacion.component.html',
  styleUrls: ['./registro-nota-autoevaluacion.component.css']
})
export class RegistroNotaAutoevaluacionComponent implements OnInit {
  ...
  save(){
    ...
    if (this.actionType === 'Add'){
      ...
      .subscribe((data) => {
        ...
        this.router.navigate(['/addRegistroAutoevaluacion/', this.listId['id']]);
      });
    }
  }

...
@Component({
  selector: 'app-registro-representante-madre',
  templateUrl: './registro-representante-madre.component.html',
  styleUrls: ['./registro-representante-madre.component.css']
})
export class RegistroRepresentanteMadreComponent implements OnInit {
  ...
  save(){
    ...
    if (this.actionType === 'Add'){
      ...
      .subscribe((data) => {
        ...
        this.router.navigate(['/registro-representante-tutor']);
      });
    }
  }

...
@Component({
  selector: 'app-registro-representante-tutor',
  templateUrl: './registro-representante-tutor.component.html',
  styleUrls: ['./registro-representante-tutor.component.css']
})
export class RegistroRepresentanteTutorComponent implements OnInit {
  form: FormGroup;
  actionType: string;
